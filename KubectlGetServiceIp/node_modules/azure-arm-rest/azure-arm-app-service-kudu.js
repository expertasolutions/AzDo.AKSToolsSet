...
class Kudu {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (response.statusCode == 200) {
                    ...
                    let affinityCookie = response.headers['set-cookie'];
                    if (!!pollableURL) {
                        tl.debug(`Polling for ZIP Deploy URL: ${pollableURL}`);
                        return yield this._getDeploymentDetailsFromPollURL(pollableURL, affinityCookie);
                    }
                    else {
    ...
    _getDeploymentDetailsFromPollURL(pollURL, affinityCookie) {
        return __awaiter(this, void 0, void 0, function* () {
            let httpRequest = new webClient.WebRequest();
            httpRequest.method = 'GET';
